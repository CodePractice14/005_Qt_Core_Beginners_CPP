...
//11-2. Connecting and disconnecting
int main(int argc, char *argv[])
{
    ...
    channels[2] = new station(&boombox, 85, "The News");

    //Qt::QueuedConnection -- used when working with threads
    ...
    do {
       ...
       if(line == "ON"){
           ...
           for(int  i = 0; i < 3; i++){
               station* channel = channels[i];
               channel->broadcast("Broadcasting live: Video killed the radio star! :'(");
           }
